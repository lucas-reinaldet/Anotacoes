...
from minio_process import Progress
...
# part_size indica que o documento vai ser enviado em parts, e caso ocorra alguma falha, 
# se inicia da ultima parte enviada com sucesso.
data = urlopen(
...
result = client().put_object(
    "pythonbucketlock", "my-object-metadata", io.BytesIO(b"hello"), 5,
...
# Criar um objeto para criar tags para  os objetos
